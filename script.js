...
function toggleMode() {
  ...
  if (html.classList.contains("light")) {
    ...
    img.setAttribute("src", "./guga-avatar-light.png")
    img.setAttribute("alt", "Foto de Gustavo de camisa preta")
  } else {
    // se tiver sem light mode, manter a imagem normal
    img.setAttribute("src", "./guga-avatar.png")
    img.setAttribute("alt", "Foto de Gustavo de camisa preta")
  }
}
...
function buttonEmail() {
  ...
  document.getElementById('shareMobile').addEventListener('click', function() {
    ...
    if (navigator.share) {
      navigator.share({
      title: 'Portfólio de Gustavo Cardoso',
      url: '#'
      })
      .then(() => {
